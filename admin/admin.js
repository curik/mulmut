(function (angular) {
    ...
    var app = angular.module('myApp.admin', ['ngRoute']);

    app.controller('AdminCtrl', ['$scope', '$location', '$firebaseArray', 'user', 'orders', function($scope, $location, $firebaseArray, user, orders) {
