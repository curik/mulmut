(function (angular) {
    ...
    var app = angular.module('myApp.bidboard', ['ngRoute']);

    app.controller('BidBoardCtrl', ['$scope', '$location', '$firebaseArray', 'user', 'orders', function($scope, $location, $firebaseArray, user, orders) {
        ...
        $scope.bidOrder = function (orderRef) {
            $location.path("/bid/" + orderRef);
        };
    ...
    app.config(['$routeProvider', function($routeProvider) {
        $routeProvider.whenAuthenticated('/bidboard', {
            templateUrl: 'bidboard/bidBoard.html',
            controller: 'BidBoardCtrl'
        });
    }]);
